                            ...
                            .then(() => {
                                emailVerification()
                                    .then(() => {
                                        ...
                                        fetch(`https://taskzen.onrender.com/api/user/add`, {
                                            method: 'POST',
                                            headers: {
        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
                <form onSubmit={handleSubmit(handleSignUp)} className="w-full max-w-md">
                    ...
                    <h1 className="mt-3 text-2xl text-center font-semibold text-gray-800 capitalize sm:text-3xl dark:text-white">Sign Up</h1>
                    ...
                    <div className="mt-6">
                        ...
                        <Link onClick={handleGoogleSignUp} className="flex items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
