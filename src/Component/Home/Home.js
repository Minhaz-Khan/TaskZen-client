    ...
    return (
        <section class="bg-white dark:bg-gray-900">
            <div class="container px-6 py-16 mx-auto text-center">
                <div class="max-w-xl mx-auto md:pt-24 lg:pt-48">
                    <h1 class="text-3xl font-bold text-gray-800 dark:text-white lg:text-6xl ">Organize your
                        work and life, finally.</h1>
                    <p class="mt-6 text-gray-500 dark:text-gray-300 ">Become focused, organized, and calm with TaskZen. The world’s #1 task manager and TaskZen list app.</p>
                    <button class="px-5 py-2 mt-6 text-sm font-medium leading-5 text-center text-white capitalize bg-primary rounded-lg hover:bg-secondary lg:mx-0 lg:w-auto focus:outline-none">
                        Start for free
                    </button>
                </div>
            ...
            <div className=' w-full   py-10 -bottom-0 bg-[#fae8d5]'>
                <div className='flex justify-center space-x-20'>
                    <div className='text-left space-y-2'>
                        <p>300,000+ REVIEWS</p>
                        <div class="flex">
                            <svg class="h-4 w-4 shrink-0 fill-amber-500" aria-hidden="true" viewBox="0 0 256 256">
                                <path
