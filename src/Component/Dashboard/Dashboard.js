                                    ...
                                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                        <div className="sm:flex sm:items-start">
                                            ...
                                            <div className="mt-3 text-center  sm:mt-0 sm:text-left">
                                                ...
                                                <input type="text" placeholder='Title' className='w-full border-2 rounded py-2 pl-2 border-slate-300' />
                                                <div className="mt-2">
                                                    <textarea name="" id="" cols='60' rows="6" placeholder='Task Details' className='border-2 rounded py-2 pl-2 border-slate-300'></textarea>
                                                </div>
                                                <p>Set time</p>
