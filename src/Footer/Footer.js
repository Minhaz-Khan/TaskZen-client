...
const Footer = () => {
    return (
        <footer className="bg-[#fae8d5] dark:bg-gray-900 font-bold">
                ...
                <div className="lg:flex">
                    <div className="w-full -mx-6 lg:w-2/5">
                        <div className="px-6">
                            ...
                            <p className="max-w-sm mt-2 text-gray-500 dark:text-gray-400">Join millions of people who organize work and life with Todoist.</p>
