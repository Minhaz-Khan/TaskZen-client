...
const Footer = () => {
    return (
        <footer class="bg-[#fae8d5] dark:bg-gray-900 font-bold">
            <div class="container p-6 mx-auto">
                <div class="lg:flex">
                    <div class="w-full -mx-6 lg:w-2/5">
                        <div class="px-6">
                            <a href="#">
                                <h3 className='text-primary text-2xl'>TaskZen</h3>
                            </a>

                            <p class="max-w-sm mt-2 text-gray-500 dark:text-gray-400">Join millions of people who organize work and life with Todoist.</p>

                            <div class="flex mt-6 -mx-2">
                                <a href="#"
                                    class="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-primary"
                                    aria-label="Reddit">
